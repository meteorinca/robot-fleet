...
#define RF_FREQ_STR(x) _RF_STR(x)
        ...
        "<div style='margin-bottom:10px;font-size:12px;color:#888;'>Relay RF code to SpeakerBot API (e.g. speakerbot1.local/choola). Enabled by default.</div>"
        ...
        "  <input type='text' id='rf-relay-host' placeholder='speakerbot1.local/choola' value='speakerbot1.local/choola' style='margin-bottom:0;'>"
        "</div>"
        "<div style='display:flex;gap:8px;'>"
