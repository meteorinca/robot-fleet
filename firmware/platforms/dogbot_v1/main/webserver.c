...
static esp_err_t anim_mario_handler(httpd_req_t *req) { dog_set_display_mode(DISP_MODE_MARIO_DANCE); httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*"); httpd_resp_send(req, "OK", HTTPD_RESP_USE_STRLEN); return ESP_OK; }
static esp_err_t anim_fireworks_handler(httpd_req_t *req) { dog_set_display_mode(DISP_MODE_FIREWORKS); httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*"); httpd_resp_send(req, "OK", HTTPD_RESP_USE_STRLEN); return ESP_OK; }
static esp_err_t anim_matrix_handler(httpd_req_t *req) { dog_set_display_mode(DISP_MODE_MATRIX_RAIN); httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*"); httpd_resp_send(req, "OK", HTTPD_RESP_USE_STRLEN); return ESP_OK; }
static esp_err_t anim_invader_handler(httpd_req_t *req) { dog_set_display_mode(DISP_MODE_SPACE_INVADER); httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*"); httpd_resp_send(req, "OK", HTTPD_RESP_USE_STRLEN); return ESP_OK; }
static esp_err_t anim_heartbeat_handler(httpd_req_t *req) { dog_set_display_mode(DISP_MODE_HEARTBEAT); httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*"); httpd_resp_send(req, "OK", HTTPD_RESP_USE_STRLEN); return ESP_OK; }
static esp_err_t game_off_handler(httpd_req_t *req) { dog_set_display_mode(DISP_MODE_EYES); httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*"); httpd_resp_send(req, "OK", HTTPD_RESP_USE_STRLEN); return ESP_OK; }
